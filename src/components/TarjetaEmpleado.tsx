  ...
  return (
    <div className="tarjeta">
      ...
      <div className="credenciales-contenedor">
        <button className="btn-credenciales" onClick={() => setVerCredenciales(!verCredenciales)}>
        ...
        {verCredenciales && (
          <div className="credenciales-box">
            <p>
              📧 <strong>Email:</strong> {empleado.email || 'No asignado'}
            </p>
            <p>
              🔑 <strong>Contraseña:</strong> italica123
            </p>
            <p style={{ fontSize: '11px', color: '#999', marginTop: '6px' }}>💡 El empleado puede cambiar su contraseña después</p>
          </div>
        )}
      </div>
