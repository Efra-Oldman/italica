...
function Empresa() {
  ...
  if (cargando) return <div className="pagina"><p>Cargando...</p></div>

  return (
    <div className="pagina">
      <h1>🏢 Perfil de ITALICA BOLIVIA</h1>
      <p style={{ color: "#666", marginBottom: "24px", fontSize: "14px" }}>
        Esta información es usada por la IA para hacer recomendaciones más precisas y relevantes para tu empresa.
      </p>
        ...
        <div className="formulario-grid">
          ...
          <div className="campo">
            ...
            <input
              ...
              onChange={(e) => handleChange("sucursales", e.target.value)}
            />
          </div>
      ...
      <div className="formulario-empleado">
        ...
        <div className="campo" style={{ marginBottom: "16px" }}>
          ...
          <textarea
            ...
            rows={2}
            value={form.marcas || ""}
            onChange={(e) => handleChange("marcas", e.target.value)}
          />
        </div>
        ...
        <div className="campo" style={{ marginBottom: "16px" }}>
          ...
          <textarea
            className="textarea-descripcion"
            rows={3}
            value={form.clientesTipicos || ""}
            onChange={(e) => handleChange("clientesTipicos", e.target.value)}
          />
        </div>
        ...
        <div className="campo" style={{ marginBottom: "16px" }}>
          ...
          <textarea
            className="textarea-descripcion"
            rows={3}
            value={form.procesoVenta || ""}
            onChange={(e) => handleChange("procesoVenta", e.target.value)}
          />
        </div>
      </div>
      ...
      <div className="formulario-empleado">
        ...
        <div className="campo" style={{ marginBottom: "16px" }}>
          ...
          <textarea
            className="textarea-descripcion"
            rows={3}
            value={form.valoresEmpleado || ""}
            onChange={(e) => handleChange("valoresEmpleado", e.target.value)}
          />
        </div>
      ...
      <div className="formulario-empleado">
        ...
        <p style={{ fontSize: "13px", color: "#666", marginBottom: "12px" }}>
          Así es exactamente como la IA leerá la información de tu empresa en cada consulta.
        </p>
        <div style={{
          background: "#f3f4ff",
